...
\end{subfigure}
\hfill
\caption{(a) 3 continuous vertices in $c_n$ dominated by $D^c_{n+1}(P)$. Circle vertices are vertices in $P$, star vertices are vertices in $v_{k'}$, triangle vertices are vertices in $v_k$; (b) Partial of $P'$ that could replace $P$.}
\label{fig:lem2}
\end{figure}
