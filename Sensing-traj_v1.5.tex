...
\centering
\includegraphics[height=0.7\linewidth]{pix/sensing-traj/dominating_set.pdf}
\caption{A dominating set of $L_{8,7}$;}
\label{fig:dominating_set}
\end{subfigure}%
\hfill
\begin{subfigure}[t]{0.32\textwidth}
\centering
\includegraphics[height=0.7\linewidth]{pix/sensing-traj/con_dominating_set.pdf}
\caption{A connected dominating set of $L_{8,7}$;}
\label{fig:con_dominating_set}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.32\textwidth}
\centering
\includegraphics[height=0.7\linewidth]{pix/sensing-traj/dominating_path.pdf}
\caption{A dominating path of $L_{8,7}$;}
\label{fig:dominating_path}
\end{subfigure}
\caption{A dominating set, connected dominating set and dominating path of $L_{8,7}$. In dominating path, orange vertices are dominating vertices and green vertices are connecting vertices.}
...
\centering
\includegraphics[height=0.7\linewidth]{pix/sensing-traj/trivial_step_1.pdf}
...
\begin{subfigure}[t]{0.24\textwidth}
\centering
\includegraphics[height=0.7\linewidth]{pix/sensing-traj/trivial_step_2.pdf}
...
\begin{subfigure}[t]{0.24\textwidth}
\centering
\includegraphics[height=0.7\linewidth]{pix/sensing-traj/trivial_step_3.pdf}
\caption{A minimum dominating path of $L_{6,3}$;}
\label{fig:trivial_step_3}
\end{subfigure}
\begin{subfigure}[t]{0.24\textwidth}
\centering
\includegraphics[height=0.7\linewidth]{pix/sensing-traj/trivial_step_further.pdf}
...
\centering
\includegraphics[height=0.7\linewidth]{pix/sensing-traj/lem2_prob.pdf}
\caption{3 continuous vertexes in $c_n$ dominated by $D^c_{n+1}(P)$. Circle vertices are vertices in $P$, star vertices are vertices in $v_{k'}$, triangle vertices are vertices in $v_k$.}
\label{fig:lem2_prob}
\end{subfigure}%
\hfill
\begin{subfigure}[t]{0.45\textwidth}
\centering
\includegraphics[height=0.7\linewidth]{pix/sensing-traj/lem2_sol.pdf}
\caption{Partial of $P'$ that could replace $P$.}
\label{fig:lem2_sol}
\end{subfigure}
\hfill
\caption{}
...
\begin{subfigure}[t]{0.45\textwidth}
\centering
\includegraphics[height=0.7\linewidth]{pix/sensing-traj/thm4_struct_boundary.pdf}
\caption{Typical structure of minimum dominating path on the boundary.}
\label{fig:thm4_struct_boundary}
\end{subfigure}%
\hfill
\begin{subfigure}[t]{0.45\textwidth}
\centering
\includegraphics[height=0.7\linewidth]{pix/sensing-traj/thm4_period.pdf}
\caption{2-period coverage and 3-period coverage of specific structure.}
