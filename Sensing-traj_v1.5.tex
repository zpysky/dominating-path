...
Let $V_C \subseteq V$ denotes the set of COLs, and $v_{C_i}$ is the $i$-th vertex in $V_C$. Let $V_P \subseteq V$ denote the set of vertices in the drone's trajectory which forms a path in $\mathcal{G}$. We have $V_C \subseteq V_P$ since the trajectory should contain the COLs, i.e., vertices in $V_C$.
