...
% XXX~definition first , then theorem?
...
We could get minimum dominating path of $L_{4,4}$ in Figure~\ref{fig:path4_1}. Therefore, we could use two meta structs 2 to construct minimum dominating path of $L_{4,7}$ and $L_{4,10}$ and we could use meta struct 2 to construct minimum dominating path of $L_{7,7}$. And we could construct minimum dominating path of $L_{4,n}$ when $n \geq 10$ from $L_{1,n}$ with a meta struct 1. Finally, for $m \geq 7$, $n \geq 10$, we could only use meta struct 3 to construct minimum dominating path of $L_{m,n}$ from $L_{m-3,n}$ which get the result in Figure~\ref{fig:path4_1}.
