...
\caption{Time consumed of three algorithms with different loads when considering flight time only.}
...
\caption{Coverage space of three algorithms with different loads when considering flight time only.}
...
\caption{Time consumed of three algorithms in different measurement space.}
...
\caption{Coverage space of three algorithms in different measurement space.}
...
\subsection{Simulation results in different-size spaces}
In experiments, we only test the performance of compared algorithm in a give 3d space with the fixed size. In simulations, we can evaluate the algorithm performance in different-size spaces.
